...
const StyledLabelText: FunctionComponent<Props> = ({ className, text, value, req, name, image, autof, type, onChange, handleInput, description, inputMode, autoComplete, placeHolder }) => {
  return (
